...
public class Calculadora {
    public static void main(String[] args) {
        ...
        String operacaoString = keyboard.next(); // next e nextLine usado para String

        System.out.print("Digite mais um número: ");
        float n2 = (float) keyboard.nextFloat();

        //.equals é usado para comparar o conteúdo de uma string ao invés de ==
        ...
        } else if (operacaoString.equals("x")) {
            float n3 = (float) n1 * n2;
